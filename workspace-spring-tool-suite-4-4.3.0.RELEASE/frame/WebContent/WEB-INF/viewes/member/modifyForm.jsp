...
<form method="post" action="/frame/member/modifyPro.do" name="userinput" onsubmit="return checkIt()">
   ...
   <tr> 
    ...
    <tr> 
      <td colspan="2" align="center" bgcolor="${value_c}"> 
       ...
       <input type="button" value="취  소" onclick="javascript:window.location='/frame/member/main.do'">      
      </td>
    </tr>
  </table>
</form>
