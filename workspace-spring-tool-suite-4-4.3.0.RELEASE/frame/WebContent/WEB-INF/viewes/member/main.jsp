...
<body onLoad="focusIt();" bgcolor="${bodyback_c}">
  <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
      <tr>
       ...
       <form name="inform" method="post" action="/frame/member/loginPro.do"  onSubmit="return checkIt();">
      ...
      <tr > 
       ...
       <tr>
          <td colspan="3" bgcolor="${title_c}"   align="center">
            ...
            <input type="button"  value="회원가입" onclick="javascript:window.location='/frame/member/inputForm.do'">
          </td></form></tr></table>
       ...
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="${value_c}" align="center">
             ...
             방문하셨습니다
             <form  method="post" action="/frame/member/logout.do">  
             <input type="submit"  value="로그아웃">
             <input type="button" value="회원정보변경" onclick="javascript:window.location='/frame/member/modify.do'">
             </form>
         </td>
        </tr>
       <tr > 
