...
<form name="myform" action="/frame/member/deletePro.do" method="post" onSubmit="return checkIt()">
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle" bgcolor="${value_c}" >
      ...
      <input type="button" value="취  소" onclick="javascript:window.location='/frame/member/main.do'"></TD></TR>
</TABLE>
</form>
</BODY>
</HTML>
