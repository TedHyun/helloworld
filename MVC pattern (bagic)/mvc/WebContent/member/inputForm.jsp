...
<form method="post" action="/mvc/inputPro.do" name="userinput" onSubmit="return checkIt()">
  <table width="600" border="1" cellspacing="0" cellpadding="3" align="center" >
    ...
    <tr> 
      <td colspan="2" align="center" bgcolor="${value_c}"> 
          ...
          <input type="button" value="가입안함" onclick="javascript:window.location='/mvc/main.do'">
      </td>
    </tr>
  </table>
</form>
